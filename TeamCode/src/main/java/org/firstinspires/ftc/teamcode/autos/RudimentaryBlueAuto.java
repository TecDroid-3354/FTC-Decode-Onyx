...
public class RudimentaryBlueAuto extends LinearOpMode {
    ...
    static final double     COUNTS_PER_MOTOR_REV    = MecanumConstants.Physics.countPerRevolution;   // eg: GoBILDA 312 RPM Yellow Jacket
    ...
    */
    ...
    private void sendTelemetry(boolean straight) {
        ...
        if (straight) {
            ...
            telemetry.addData("Actual Pos L:R",  "%7d:%7d:%7d:%7d",      frontRightMotor.getCurrentPosition(),
                    frontLeftMotor.getCurrentPosition(), backRightMotor.getCurrentPosition(), backLeftMotor.getCurrentPosition());
        } else {
